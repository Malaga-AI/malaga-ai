    ...
    <section id="join" className="scroll-mt-24 py-20 md:py-28" aria-labelledby="join-title">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-10 rounded-[2rem] border border-border bg-surface p-8 shadow-glow md:p-14 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            <h2 id="join-title" className="font-safiro text-4xl leading-tight text-foreground md:text-5xl">
          ...
          <form id="join-form" className="grid gap-4" onSubmit={handleJoinSubmit}>
            ...
            <div className="grid gap-2">
              <label className="text-sm font-medium text-muted-foreground" htmlFor="join-email">
                Email
              </label>
              <input
                id="join-email"
            ...
            <div className="grid gap-2">
              <label className="text-sm font-medium text-muted-foreground" htmlFor="join-interest">
                Interest
              </label>
              <select
                id="join-interest"
            ...
            <div className="grid gap-2">
              <label className="text-sm font-medium text-muted-foreground" htmlFor="join-message">
                Message
              </label>
              <textarea
                id="join-message"
