    ...
    <section id="friends" className="scroll-mt-24 py-20 md:py-28" aria-labelledby="friends-title">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          <p className="text-sm font-semibold uppercase tracking-[0.22em] text-teal-200">Friendly Communities</p>
          <h2 id="friends-title" className="mt-3 font-safiro text-4xl text-white md:text-5xl">Local groups we are glad to share space with</h2>
